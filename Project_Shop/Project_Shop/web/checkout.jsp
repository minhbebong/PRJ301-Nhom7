<%-- 
    Document   : checkout
    Created on : Jun 20, 2022, 3:28:06 PM
    Author     : bavan
--%>
                    ...
                    <form action="#">
                        <div class="row">
                            <div class="col-lg-8 col-md-6">
                                <h6 class="coupon__code"><span class="icon_tag_alt"></span> Có phiếu giảm giá? <a href="#">Nhấp chuột
                                        tại đây </a> để nhập mã của bạn</h6>
                                ...
                                <div class="checkout__input">
                                    ...
                                    <input type="text" placeholder="Vui lòng điền địa chỉ của bạn" class="checkout__input__add">
                                    <input type="text" placeholder="Căn hộ, dãy phòng, căn hộ, v.v.">
                                </div>
                                <!-- <div class="checkout__input">
                                ...
                                <div class="checkout__input__checkbox">
                                    ...
                                    <p> Tạo một tài khoản bằng cách nhập thông tin bên dưới. Nếu bạn là khách hàng cũ
                                ...
                                <div class="checkout__input__checkbox">
                                    <label for="diff-acc">
                                        Lưu ý về đơn đặt hàng của bạn, ví dụ: lưu ý đặc biệt để giao hàng
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="checkout__order">
                                    ...
                                    <p>Do ảnh hưởng của dịch bệnh Covid-19. Quá trình giao hàng có thể chậm trễ 2-3 ngày. Mong quý khách hàng thông cảm!</p>
                                    <div class="checkout__input__checkbox">
                                        <label for="payment">
                                            Kiểm tra thanh toán
