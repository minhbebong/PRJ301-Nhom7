    ...
    <section class="product spad">
        <div class="container">
            ...
            <div class="row product__filter">
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <a href="./shopping-cart.html" class="add-cart">+ Thêm vào giỏ hàng</a>
                            <div class="rating">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-Giảm giás">
                    <div class="product__item">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item Giảm giá">
                        ...
                        <div class="product__item__text">
                            ...
                            <a href="./blog-details.html" class="add-cart">+ Thêm vào giỏ hàng</a>
                            <div class="rating">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="categories__text">
                        <h2>Xu hướng mới<br /> <span>Bộ sưu tập giày</span> <br />Phụ kiện</h2>
                    </div>
                </div>
                <div class="col-lg-4">
